...
-- CTRL+<hjkl> window navigation lives in lua/custom/plugins/tmux-navigator.lua.
-- It moves between nvim windows and crosses into tmux panes at the edge.
--
...
-- Markdown editing helpers (checkbox toggling)
  ...
  },
  {
    ...
    config = function()
      ...
      vim.diagnostic.config {
        ...
        -- hide inline diagnostic messages
        virtual_text = false,
        -- virtual_text = {
        --   source = 'if_many',
        --   spacing = 2,
  ...
  { -- Autocompletion
    ...
    opts = {
      keymap = {
        ...
        --
        -- Custom: <tab>/<s-tab> insert spaces (no snippet navigation)
        --
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      statusline.setup {
        ...
        content = {
          -- Hide statusline content for neo-tree and other special buffers
          inactive = function()
